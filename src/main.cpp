...
unsigned int nTargetSpacing = 1 * 30; // FidgetCoin - 30 seconds blocks
...
const string strMessageMagic = "FidgetCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	{ 
		nSubsidy = 82800 * COIN; return nSubsidy; 
	}
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "FidgetCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Spin, Press, Touch, Wobble, Click, Do as much as you like - Fidgeters Unite – 28th May 2017";
        CTransaction txNew;
        txNew.nTime = 1495924587;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		uint256 nhashMerkleRoot = uint256("0xeb1e47d1ec28ddfb151b93e9cc84d7644ab6231e95c1051f2d0246757c9f0dff");
